<x-mobile-layout>
    ...
    <article id="section-list"
        class="bg-white overflow-y-scroll shadow-lg border border-gray-200 sm:rounded-lg
     h-screen snap-y snap-mandatory">
        <section class="p-6 text-gray-900 h-screen pt-20 flex justify-center items-center snap-start">
            <x-primary-button>{{ __('Create a new list') }}</x-primary-button>
        </section>
        <section class="p-6 text-gray-900 h-screen pt-20 snap-start">
