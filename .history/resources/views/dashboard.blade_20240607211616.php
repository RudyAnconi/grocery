<x-mobile-layout>
    ...
    <article id="section-list"
     ...
     h-dvh snap-y snap-mandatory">
        <section class="p-6 text-gray-900 h-screen pt-20 flex justify-center items-center snap-start border border-gray-200 ">
            <x-primary-button>{{ __('Create a new list') }}</x-primary-button>
        </section>
        <section class="p-6 text-gray-900 h-screen pt-20 snap-start border border-gray-200">
